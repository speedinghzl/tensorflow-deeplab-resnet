...
class RefineResNetModel(Network):
    def setup(self, is_training, num_classes):
        ...
        (self.feed('bn4a_branch1', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b1_branch2b')
        ...
        (self.feed('res4a_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b2_branch2b')
        ...
        (self.feed('res4b1_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b3_branch2b')
        ...
        (self.feed('res4b2_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b4_branch2b')
        ...
        (self.feed('res4b3_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b5_branch2b')
        ...
        (self.feed('res4b4_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b6_branch2b')
        ...
        (self.feed('res4b5_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b7_branch2b')
        ...
        (self.feed('res4b6_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b8_branch2b')
        ...
        (self.feed('res4b7_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b9_branch2b')
        ...
        (self.feed('res4b8_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b10_branch2b')
        ...
        (self.feed('res4b9_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b11_branch2b')
        ...
        (self.feed('res4b10_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b12_branch2b')
        ...
        (self.feed('res4b11_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b13_branch2b')
        ...
        (self.feed('res4b12_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b14_branch2b')
        ...
        (self.feed('res4b13_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b15_branch2b')
        ...
        (self.feed('res4b14_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b16_branch2b')
        ...
        (self.feed('res4b15_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b17_branch2b')
        ...
        (self.feed('res4b16_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b18_branch2b')
        ...
        (self.feed('res4b17_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b19_branch2b')
        ...
        (self.feed('res4b18_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b20_branch2b')
        ...
        (self.feed('res4b19_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b21_branch2b')
        ...
        (self.feed('res4b20_relu', 
             ...
             .conv(3, 3, 256, 1, 1, padding='SAME', biased=False, relu=False, name='res4b22_branch2b')
        ...
        (self.feed('res5c_relu')
             .conv(3, 3, 512, 1, 1, padding='SAME', relu=False, name='RefineNet_res5c_reduce', biased=False)
             .residual_conv_unit(name='RefineNet4_RCU_0')
             .residual_conv_unit(name='RefineNet4_RCU_1')
             .relu(name='RefineNet4_relu_0')
             .chained_residual_pooling(name='RefineNet4_CRP', num=4)
             .residual_conv_unit(name='RefineNet4_RCU_2')
             .residual_conv_unit(name='RefineNet4_RCU_3')
             .residual_conv_unit(name='RefineNet4_RCU_4'))

        (self.feed('res4b22_relu')
             .conv(3, 3, 256, 1, 1, padding='SAME', relu=False, name='RefineNet_res4b_reduce', biased=False)
             .residual_conv_unit(name='RefineNet3_RCU_0')
             .residual_conv_unit(name='RefineNet3_RCU_1'))
        (self.feed('RefineNet4_RCU_4',
                   'RefineNet3_RCU_1')
             .multi_scale_fusion(name='RefineNet3_fusion')
             .relu(name='RefineNet3_relu_0')
             .chained_residual_pooling(name='RefineNet3_CRP', num=4)
             .residual_conv_unit(name='RefineNet3_RCU_2')
             .residual_conv_unit(name='RefineNet3_RCU_3')
             .residual_conv_unit(name='RefineNet3_RCU_4'))

        (self.feed('res3b3_relu')
             .conv(3, 3, 256, 1, 1, padding='SAME', relu=False, name='RefineNet_res3b_reduce', biased=False)
             .residual_conv_unit(name='RefineNet2_RCU_0')
             .residual_conv_unit(name='RefineNet2_RCU_1'))
        (self.feed('RefineNet3_RCU_4',
                   'RefineNet2_RCU_1')
             .multi_scale_fusion(name='RefineNet2_fusion')
             .relu(name='RefineNet2_relu_0')
             .chained_residual_pooling(name='RefineNet2_CRP', num=4)
             .residual_conv_unit(name='RefineNet2_RCU_2')
             .residual_conv_unit(name='RefineNet2_RCU_3')
             .residual_conv_unit(name='RefineNet2_RCU_4'))

        (self.feed('res2c_relu')
             .conv(3, 3, 256, 1, 1, padding='SAME', relu=False, name='RefineNet_res2c_reduce', biased=False)
             .residual_conv_unit(name='RefineNet1_RCU_0')
             .residual_conv_unit(name='RefineNet1_RCU_1'))
        (self.feed('RefineNet2_RCU_4',
                   'RefineNet1_RCU_1')
             .multi_scale_fusion(name='RefineNet1_fusion')
             .relu(name='RefineNet1_relu_0')
             .chained_residual_pooling(name='RefineNet1_CRP', num=4)
             .residual_conv_unit(name='RefineNet1_RCU_2')
             .residual_conv_unit(name='RefineNet1_RCU_3')
             .residual_conv_unit(name='RefineNet1_RCU_4'))

        (self.feed('RefineNet1_RCU_4')
             .conv(3, 3, num_classes, 1, 1, padding='SAME', relu=False, name='RefineNet_scores'))
