...
def main():
    ...
    # Create network.
    net = RefineResNetModel({'data': image_batch}, is_training=args.is_training, num_classes=n_classes)
    ...
    fc_trainable = [v for v in all_trainable if 'RefineNet' in v.name]
    conv_trainable = [v for v in all_trainable if 'RefineNet' not in v.name] # lr * 1.0
